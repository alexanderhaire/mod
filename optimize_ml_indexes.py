...
INDEX_STATEMENTS = [
    ...
    """
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_POP30310_ITEMNMBR_ACTLSHIP')
    CREATE NONCLUSTERED INDEX IX_POP30310_ITEMNMBR_ACTLSHIP 
    ON POP30310 (ITEMNMBR, ACTLSHIP) 
    ...
    """
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IV00102_ITEMNMBR')
    CREATE NONCLUSTERED INDEX IX_IV00102_ITEMNMBR 
    ON IV00102 (ITEMNMBR) 
    INCLUDE (QTYONHND, QTYONORD, ORDERPNT)
    """,
]
